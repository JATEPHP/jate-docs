var store = [{
        ...
        "teaser":null},{
        "title": "Connection",
        "excerpt":"To enable the connection to the database, set \"enable\":true and fill the other fields.Only one engine can be selected at the same time.{  \"enable\":    false,  \"user\":      \"\",  \"password\":  \"\",  \"database\":  \"\",  \"server\":    \"\",  \"engine\": {    \"pdo-mysql\":         true,    \"pdo-sqlite-memory\": false,    \"pdo-sqlite-file\":   false,    \"mysqli\":            false,    \"postgresql\":        false  }}","categories": [],
        "tags": [],
        ...
        "teaser":null},{
        "title": "Version 0.5.4",
        "excerpt":"Added two new functions:  view  sqlChanged config/connection.json:from{  \"enable\":    false,  \"user\":      \"\",  \"password\":  \"\",  \"database\":  \"\",  \"server\":    \"\",  \"engine\": {    \"pdo\":        true,    \"mysqli\":     false,    \"postgresql\": false  }}to{  \"enable\":    false,  \"user\":      \"\",  \"password\":  \"\",  \"database\":  \"\",  \"server\":    \"\",  \"engine\": {    \"pdo-mysql\":         true,    \"pdo-sqlite-memory\": false,    \"pdo-sqlite-file\":   false,    \"mysqli\":            false,    \"postgresql\":        false  }}","categories": [],
        "tags": [],
        "url": "http://localhost:4000/jate-docs/version-0-5-4",
        "teaser":null},]
